(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-hero__slider")) new core(".main-hero__slider", {
            ...
            pagination: {
                ...
                renderBullet: function(index, className) {
                    return '<span class="slider-nav__pagination-bullet ' + className + '">' + ("0" + (index + 1)).slice(-2) + '<span class="slider-nav__pagination-timer"></span></span>';
                }
            },
            navigation: {
    ...
    da.init();
    const videoPlayer = document.querySelector(".main-video__video");
    const videoPlayed = videoPlayer.querySelector(".player-video__video");
    const playButton = videoPlayer.querySelector(".player-video__play-btn");
    const muteButton = videoPlayer.querySelector(".player-video__mute-btn");
    playButton.addEventListener("click", (e => {
        if (videoPlayed.paused) {
            e.stopPropagation();
            videoPlayed.play();
            videoPlayer.classList.remove("_active-controls", "_paused");
        } else {
            videoPlayed.pause();
            videoPlayer.classList.add("_active-controls", "_paused");
        }
    }));
    ...
    muteButton.addEventListener("click", (e => {
        e.stopPropagation();
        videoPlayed.muted = !videoPlayed.muted;
        muteButton.classList.toggle("_unmuted");
    }));
    window["FLS"] = true;
    isWebp();
    addLoadedClass();
